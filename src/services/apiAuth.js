...
export async function updateCurrentUser({ password, fullName, avatar }) {
  // 1. Atualiza a password ou o fullName:
  let updateData;
  ...
  // 2. Faz o upload da imagem do avatar:
  ...
  // 3.Atualiza o avatar no user:

  const { data: updatedUser, errorUpdateUser } = await supabase.auth.updateUser(
    {
      data: {
